...
public class PlaybackIjkActivity extends BaseActivity {

    private ActivityPlaybackBinding binding;
    private PlaybackIjkFragment mPlaybackFragment;
    ...
    public static void launch(Context activity, VideoDetailInfo data) {
        Intent intent = new Intent(activity, PlaybackIjkActivity.class);
    ...
    public void initView() {
        ...
        mPlaybackFragment = new PlaybackIjkFragment();
