 ...
 * row.
 */
public class IjkVideoPlayerGlue extends PlaybackTransportControlGlue<LeanbackIjkPlayerAdapter> {
    ...
    public IjkVideoPlayerGlue(
            Context context,
            LeanbackIjkPlayerAdapter playerAdapter,
